...
def test_case_data(test_case):
    ...
    if test_case == 1:
        ...
        data = [{'type': 'straight_beam', 'endpoint': [[237.5, 480], [362.5, 480]], 'line_load': 'linear_descending', 'coordinate_system_position': True, 'coordinate_system_orientation': True},
                {'type': 'fixed_bearing', 'endpoint': [[237.5, 480]]}, 
                {'type': 'straight_beam', 'endpoint': [[362.5, 373.375], [487.5, 373.375]], 'line_load': 'constant', 'coordinate_system_position': True, 'coordinate_system_orientation': True},
